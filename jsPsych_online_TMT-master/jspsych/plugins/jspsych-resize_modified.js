...
window.jsPsychResizeModified = jsPsych.plugins['resize_modified'];

jsPsychResizeModified.trial = function(jsPsych, display_element, trial) {
  return jsPsych.plugins['resize_modified'].trial(display_element, trial);
};
