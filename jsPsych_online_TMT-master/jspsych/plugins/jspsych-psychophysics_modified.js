...
window.jsPsychPsychophysicsModified = jsPsych.plugins['psychophysics_modified'];

jsPsychPsychophysicsModified.trial = function(jsPsych, display_element, trial) {
  return jsPsych.plugins['psychophysics_modified'].trial(display_element, trial);
};
